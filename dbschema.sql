...
) ENGINE=MyISAM AUTO_INCREMENT=31879273 DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `NUKE` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=506357 DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `XTRA` (
  ...
  UNIQUE KEY `rlsname_uniq` (`rlsname`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=24880 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
